...
export default function Home() {
  ...
  return (
    <div style={{ backgroundColor: '#f7eeed' }}>
      {/* top */}
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'   >
        <h1 className='text-black-700 font-bold text-3xl lg:text-6xl'>
          Discover Your Next Home With Ease on <span style={{ color: '#FF735C' }}>StayEase</span>
          <br />
          
        </h1>
        <div className='text-black-400 text-xs sm:text-sm'>
         With StayEase, explore a wide range of properties or list your own.
          <br />
